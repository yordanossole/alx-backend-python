# Generated by Django 5.2.1 on 2025-06-01 20:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(help_text='User password', max_length=128)),
                ('bio', models.TextField(blank=True, help_text='Short biography about the user', max_length=500)),
                ('phone_number', models.CharField(blank=True, help_text='User contact number', max_length=15)),
                ('is_online', models.BooleanField(default=False, help_text='User online status')),
                ('last_seen', models.DateTimeField(auto_now=True, help_text='Last time user was active')),
